...
## 
## Makefile     : test3.mk
## Generated on : Mon May 05 12:26:48 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test3.rt-linux_qcar2
...
START_DIR                 = C:/Users/bajdus/Documents/Qcar2/Collision-Avoidance-Algorithm/IProdan_B-splines
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 1
TGT_FCN_LIB               = ISO_C
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test3.rt-linux_qcar2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test3_quarc_linux_qcar2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=test3 -DNUMST=2 -DNCSTATES=19 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/test3_quarc_linux_qcar2/rtGetInf.c $(START_DIR)/test3_quarc_linux_qcar2/rtGetNaN.c $(START_DIR)/test3_quarc_linux_qcar2/rt_nonfinite.c $(START_DIR)/test3_quarc_linux_qcar2/test3.c $(START_DIR)/test3_quarc_linux_qcar2/test3_data.c $(START_DIR)/test3_quarc_linux_qcar2/test3_main.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o test3.o test3_data.o test3_main.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/test3_quarc_linux_qcar2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/test3_quarc_linux_qcar2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
rtGetInf.o : $(START_DIR)/test3_quarc_linux_qcar2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/test3_quarc_linux_qcar2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/test3_quarc_linux_qcar2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test3.o : $(START_DIR)/test3_quarc_linux_qcar2/test3.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test3_data.o : $(START_DIR)/test3_quarc_linux_qcar2/test3_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test3_main.o : $(START_DIR)/test3_quarc_linux_qcar2/test3_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"
