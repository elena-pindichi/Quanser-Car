...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&test3_B.Product1), 0, 0, 438 },

  { (char_T *)(&test3_B.Compare), 8, 0, 1 }
  ,

  { (char_T *)(&test3_DW.HILInitialize_AIMinimums[0]), 0, 0, 2000025 },

  { (char_T *)(&test3_DW.HILInitialize_Card), 17, 0, 1 },

  { (char_T *)(&test3_DW.HILRead_PWORK), 11, 0, 12 },

  { (char_T *)(&test3_DW.HILInitialize_DOStates[0]), 6, 0, 30 },

  { (char_T *)(&test3_DW.HILInitialize_POSortedChans[0]), 7, 0, 2 },

  { (char_T *)(&test3_DW.Integrator1_IWORK), 10, 0, 8 },

  { (char_T *)(&test3_DW.is_active_c2_test3), 3, 0, 1 },

  { (char_T *)(&test3_DW.HILInitialize_DOBits[0]), 8, 0, 21 }
};
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&test3_P.Constant10_Value), 0, 0, 66 },
