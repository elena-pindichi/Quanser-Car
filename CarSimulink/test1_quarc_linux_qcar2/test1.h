...
typedef struct {
  real_T HILRead_o1;                   /* '<Root>/HIL Read' */
  real_T HILRead_o2;                   /* '<Root>/HIL Read' */
  real_T HILRead_o3;                   /* '<Root>/HIL Read' */
  real_T HILRead_o4;                   /* '<Root>/HIL Read' */
  real_T HILRead_o5;                   /* '<Root>/HIL Read' */
...
typedef struct {
  ...
  real_T HILInitialize_AIMinimums[5];  /* '<Root>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[5];  /* '<Root>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[3];/* '<Root>/HIL Initialize' */
  ...
  real_T HILRead_OtherBuffer[5];       /* '<Root>/HIL Read' */
  ...
  int32_T HILInitialize_DOStates[16];  /* '<Root>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[3];/* '<Root>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[3];/* '<Root>/HIL Initialize' */
  ...
  boolean_T HILInitialize_DOBits[16];  /* '<Root>/HIL Initialize' */
} DW_test1_T;
...
#define rtX                            test1_X
#define ContinuousStates               X_test1_T
#define rtXdot                         test1_XDot
#define StateDerivatives               XDot_test1_T
#define tXdis                          test1_XDis
#define StateDisabled                  XDis_test1_T
#define rtP                            test1_P
...
struct P_test1_T_ {
  uint32_T HILRead_other_channels[5];  /* Mask Parameter: HILRead_other_channels
 ...
 * External functions *
 *====================*/
extern test1_rtModel *test1(void);
 ...
 *
 * '<Root>' : 'test1'
 * '<S1>'   : 'test1/Multiply-Add'
 * '<S2>'   : 'test1/Powered by QUARC'
 * '<S3>'   : 'test1/Quanser'
 */
