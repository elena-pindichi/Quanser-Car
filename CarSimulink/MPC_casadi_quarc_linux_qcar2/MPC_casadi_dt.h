...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&MPC_casadi_B.Product1), 0, 0, 155 },

  { (char_T *)(&MPC_casadi_B.Compare), 8, 0, 1 }
  ,

  { (char_T *)(&MPC_casadi_DW.Buffer_CircBuf[0]), 0, 0, 2000216 },
  ...
  { (char_T *)(&MPC_casadi_DW.Buffer_inBufPtrIdx), 6, 0, 34 },
...
static DataTypeTransition rtPTransitions[] = {
  ...
  { (char_T *)(&MPC_casadi_P.Constant10_Value), 0, 0, 110 },
