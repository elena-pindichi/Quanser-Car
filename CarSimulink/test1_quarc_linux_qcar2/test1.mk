...
## 
## Makefile     : test1.mk
## Generated on : Wed Apr 09 10:35:00 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/test1.rt-linux_qcar2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test1.rt-linux_qcar2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test1_quarc_linux_qcar2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=test1 -DNUMST=2 -DNCSTATES=2 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/test1_quarc_linux_qcar2/rtGetInf.c $(START_DIR)/test1_quarc_linux_qcar2/rtGetNaN.c $(START_DIR)/test1_quarc_linux_qcar2/rt_nonfinite.c $(START_DIR)/test1_quarc_linux_qcar2/test1.c $(START_DIR)/test1_quarc_linux_qcar2/test1_data.c $(START_DIR)/test1_quarc_linux_qcar2/test1_main.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = rtGetInf.o rtGetNaN.o rt_nonfinite.o test1.o test1_data.o test1_main.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/test1_quarc_linux_qcar2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/test1_quarc_linux_qcar2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
rtGetInf.o : $(START_DIR)/test1_quarc_linux_qcar2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/test1_quarc_linux_qcar2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/test1_quarc_linux_qcar2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test1.o : $(START_DIR)/test1_quarc_linux_qcar2/test1.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test1_data.o : $(START_DIR)/test1_quarc_linux_qcar2/test1_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test1_main.o : $(START_DIR)/test1_quarc_linux_qcar2/test1_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"
