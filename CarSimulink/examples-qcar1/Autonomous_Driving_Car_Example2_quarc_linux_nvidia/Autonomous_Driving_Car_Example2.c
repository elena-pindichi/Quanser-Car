  ...
  /* S-Function Block: Autonomous_Driving_Car_Example2/basicQCarIO/HIL Initialize (hil_initialize_block) */
  {
    ...
    if ((Autonomous_Driving_Car_Exampl_P.HILInitialize_AIPStart && !is_switching)
      ...
      result = hil_set_analog_input_ranges
        (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
         Autonomous_Driving_Car_Exampl_P.HILInitialize_AIChannels, 7U,
         &Autonomous_Driving_Car_Examp_DW.HILInitialize_AIMinimums[0],
         &Autonomous_Driving_Car_Examp_DW.HILInitialize_AIMaximums[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
    ...
    result = hil_set_digital_directions
      (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
       Autonomous_Driving_Car_Exampl_P.HILInitialize_DIChannels, 20U,
       &Autonomous_Driving_Car_Exampl_P.HILInitialize_DOChannels, 1U);
    if (result < 0) {
      msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
        (_rt_error_message));
      rtmSetErrorStatus(Autonomous_Driving_Car_Examp_M, _rt_error_message);
    ...
    if ((Autonomous_Driving_Car_Exampl_P.HILInitialize_DOStart && !is_switching)
      ...
      result = hil_write_digital
        (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
         &Autonomous_Driving_Car_Exampl_P.HILInitialize_DOChannels, 1U,
         (t_boolean *) &Autonomous_Driving_Car_Exampl_P.HILInitialize_DOInitial);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
        rtmSetErrorStatus(Autonomous_Driving_Car_Examp_M, _rt_error_message);
    ...
    if ((Autonomous_Driving_Car_Exampl_P.HILInitialize_EIPStart && !is_switching)
      ...
      Autonomous_Driving_Car_Examp_DW.HILInitialize_QuadratureModes[0] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_EIQuadrature[0]);
      Autonomous_Driving_Car_Examp_DW.HILInitialize_QuadratureModes[1] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_EIQuadrature[1]);
      Autonomous_Driving_Car_Examp_DW.HILInitialize_QuadratureModes[2] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_EIQuadrature[1]);
      Autonomous_Driving_Car_Examp_DW.HILInitialize_QuadratureModes[3] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_EIQuadrature[1]);
      Autonomous_Driving_Car_Examp_DW.HILInitialize_QuadratureModes[4] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_EIQuadrature[1]);
      result = hil_set_encoder_quadrature_mode
        (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
         Autonomous_Driving_Car_Exampl_P.HILInitialize_EIChannels, 5U,
    ...
    if ((Autonomous_Driving_Car_Exampl_P.HILInitialize_POPStart && !is_switching)
      ...
      Autonomous_Driving_Car_Examp_DW.HILInitialize_POModeValues[0] =
        (Autonomous_Driving_Car_Exampl_P.HILInitialize_POModes[0]);

      {
        ...
        for (i1=0; i1 < 7; i1++) {
          dw_POModeValues[i1] =
            (Autonomous_Driving_Car_Exampl_P.HILInitialize_POModes[1]);
        }
      }

      result = hil_set_pwm_mode
        (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
         Autonomous_Driving_Car_Exampl_P.HILInitialize_POChannels, 8U,
         (t_pwm_mode *)
         &Autonomous_Driving_Car_Examp_DW.HILInitialize_POModeValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
...

      {
        ...
        for (i1=0; i1 < 8; i1++) {
          if (dw_POModeValues[i1] == PWM_DUTY_CYCLE_MODE || dw_POModeValues[i1] ==
            ...
            Autonomous_Driving_Car_Examp_DW.HILInitialize_POSortedChans[7U -
              num_frequency_modes] = (p_HILInitialize_POChannels[i1]);
            Autonomous_Driving_Car_Examp_DW.HILInitialize_POSortedFreqs[7U -
              num_frequency_modes] =
              Autonomous_Driving_Car_Exampl_P.HILInitialize_POFrequency;
            num_frequency_modes++;
          }
    ...
    if ((Autonomous_Driving_Car_Exampl_P.HILInitialize_OOStart && !is_switching)
      ...
      result = hil_write_other
        (Autonomous_Driving_Car_Examp_DW.HILInitialize_Card,
         Autonomous_Driving_Car_Exampl_P.HILInitialize_OOChannels, 13U,
         &Autonomous_Driving_Car_Examp_DW.HILInitialize_OOValues[0]);
      if (result < 0) {
        msg_get_error_messageA(NULL, result, _rt_error_message, sizeof
          (_rt_error_message));
...
RT_MODEL_Autonomous_Driving_C_T *Autonomous_Driving_Car_Example2(void)
{
  ...
  /* External mode info */
  Autonomous_Driving_Car_Examp_M->Sizes.checksums[0] = (3836866575U);
  Autonomous_Driving_Car_Examp_M->Sizes.checksums[1] = (1396515230U);
  Autonomous_Driving_Car_Examp_M->Sizes.checksums[2] = (1106244185U);
  Autonomous_Driving_Car_Examp_M->Sizes.checksums[3] = (4204234233U);
  ...
  Autonomous_Driving_Car_Examp_M->Sizes.numBlockPrms = (336);/* Sum of parameter "widths" */
