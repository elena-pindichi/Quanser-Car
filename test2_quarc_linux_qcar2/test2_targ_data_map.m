    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(4)  = dumData; %prealloc
                    ...
                    ;% test2_P.XYFigure_maximum_x
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% test2_P.XYFigure_maximum_y
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% test2_P.XYFigure_minimum_x
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% test2_P.XYFigure_minimum_y
            ...
            section.data(72)  = dumData; %prealloc
                    ...
                    ;% test2_P.Constant9_Value_f
                    section.data(34).logicalSrcIdx = 42;
                    section.data(34).dtTransOffset = 33;

                    ;% test2_P.Integrator_IC
                    ...
                    ;% test2_P.Constant_Value_l
                    section.data(38).logicalSrcIdx = 46;
                    section.data(38).dtTransOffset = 37;

                    ;% test2_P.Constant_Value_i
                    ...
                    ;% test2_P.commandsaturation_UpperSat_n
                    ...
                    ;% test2_P.Integrator5_IC
                    section.data(70).logicalSrcIdx = 78;
                    section.data(70).dtTransOffset = 69;

                    ;% test2_P.Integrator6_IC
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(14)  = dumData; %prealloc
                    ...
                    ;% test2_DW.Unwrap22_PreviousInput
                    section.data(7).logicalSrcIdx = 6;
                    section.data(7).dtTransOffset = 19;

                    ;% test2_DW.Unwrap22_Revolutions
                    section.data(8).logicalSrcIdx = 7;
                    ...
                    ;% test2_DW.XYFigure_XBuffer
                    section.data(13).logicalSrcIdx = 12;
                    section.data(13).dtTransOffset = 25;

                    ;% test2_DW.XYFigure_YBuffer
                    section.data(14).logicalSrcIdx = 13;
            ...
            section.data(11)  = dumData; %prealloc
                    ...
                    ;% test2_DW.AccX_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 17;
                    section.data(3).dtTransOffset = 2;

                    ;% test2_DW.AccY_PWORK.LoggedData
                    ...
                    ;% test2_DW.Scope3_PWORK.LoggedData
                    section.data(7).logicalSrcIdx = 21;
                    section.data(7).dtTransOffset = 6;

                    ;% test2_DW.V_PWORK.LoggedData
                    section.data(8).logicalSrcIdx = 22;
                    section.data(8).dtTransOffset = 7;

                    ;% test2_DW.Xpos_PWORK.LoggedData
                    section.data(9).logicalSrcIdx = 23;
                    section.data(9).dtTransOffset = 8;

                    ;% test2_DW.Ypos_PWORK.LoggedData
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% test2_DW.Integrator1_IWORK_d
                    section.data(4).logicalSrcIdx = 37;
                    section.data(4).dtTransOffset = 3;

                    ;% test2_DW.Integrator1_IWORK_gg
    ...
    targMap.checksum0 = 1057436919;
    targMap.checksum1 = 688295741;
    targMap.checksum2 = 3516371646;
    targMap.checksum3 = 3992229242;
