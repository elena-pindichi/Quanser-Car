...
typedef struct {
  ...
  real_T analogpower;                  /* '<S5>/HIL Read' */
  real_T motorencoder;                 /* '<S5>/HIL Read' */
  real_T HILRead_o3[4];                /* '<S5>/HIL Read' */
  real_T Integrator1;                  /* '<S11>/Integrator1' */
  real_T Unwrap22;                     /* '<S5>/Unwrap 2^2' */
  real_T Integrator1_g;                /* '<S12>/Integrator1' */
  ...
  real_T Unwrap21;                     /* '<S5>/Unwrap 2^1' */
  real_T Product_b;                    /* '<S10>/Product' */
  real_T Product_e;                    /* '<S11>/Product' */
  real_T Product1_b;                   /* '<S11>/Product1' */
  real_T Product_p;                    /* '<S12>/Product' */
  real_T Product1_g;                   /* '<S12>/Product1' */
  real_T Gain3;                        /* '<S13>/Gain3' */
  real_T Gain3_g;                      /* '<S14>/Gain3' */
  real_T switch_l;                     /* '<Root>/1 - Arm, 0 - Disarm2' */
  real_T desired;                      /* '<S6>/Multiply1' */
  real_T Kffms;                        /* '<S6>/Kff  (% // m//s)' */
  real_T measured;                     /* '<S6>/Multiply' */
  real_T pwmdutycycle;                 /* '<S6>/Multiply2' */
  real_T commandsaturation;            /* '<S5>/command saturation' */
  real_T Integrator5;                  /* '<S1>/Integrator5' */
  real_T Integrator6;                  /* '<S2>/Integrator6' */
  real_T Product_f;                    /* '<S1>/Product' */
  real_T Product1_ij;                  /* '<S2>/Product1' */
  real_T Kim;                          /* '<S6>/Ki (% // m)  ' */
...
typedef struct {
  real_T HILInitialize_AIMinimums[5];  /* '<S5>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[5];  /* '<S5>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[3];/* '<S5>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs[2];/* '<S5>/HIL Initialize' */
  real_T HILInitialize_POValues[2];    /* '<S5>/HIL Initialize' */
  real_T HILInitialize_OOValues[2];    /* '<S5>/HIL Initialize' */
  real_T Unwrap22_PreviousInput;       /* '<S5>/Unwrap 2^2' */
  real_T Unwrap22_Revolutions;         /* '<S5>/Unwrap 2^2' */
  real_T Unwrap224_PreviousInput;      /* '<S5>/Unwrap 2^24' */
  real_T Unwrap224_Revolutions;        /* '<S5>/Unwrap 2^24' */
  real_T Unwrap21_PreviousInput;       /* '<S5>/Unwrap 2^1' */
  real_T Unwrap21_Revolutions;         /* '<S5>/Unwrap 2^1' */
  ...
  int32_T HILInitialize_DOStates[16];  /* '<S5>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[3];/* '<S5>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[3];/* '<S5>/HIL Initialize' */
  int32_T HILInitialize_POModeValues[2];/* '<S5>/HIL Initialize' */
  int32_T HILInitialize_POAlignValues[2];/* '<S5>/HIL Initialize' */
  int32_T HILInitialize_POPolarityVals[2];/* '<S5>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer;       /* '<S5>/HIL Read' */
  uint32_T HILInitialize_POSortedChans[2];/* '<S5>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S11>/Integrator1' */
  int_T Integrator1_IWORK_i;           /* '<S12>/Integrator1' */
  int_T Integrator1_IWORK_g;           /* '<S7>/Integrator1' */
  int_T Integrator1_IWORK_d;           /* '<S8>/Integrator1' */
  int_T Integrator1_IWORK_gg;          /* '<S9>/Integrator1' */
  int_T Integrator1_IWORK_l;           /* '<S10>/Integrator1' */
  int_T XYFigure_IWORK[2];             /* '<Root>/XY Figure' */
  boolean_T HILInitialize_DOBits[16];  /* '<S5>/HIL Initialize' */
  boolean_T Unwrap22_FirstSample;      /* '<S5>/Unwrap 2^2' */
  boolean_T Unwrap224_FirstSample;     /* '<S5>/Unwrap 2^24' */
  boolean_T Unwrap21_FirstSample;      /* '<S5>/Unwrap 2^1' */
...
typedef struct {
  ...
  real_T Integrator2_CSTATE_i;         /* '<S8>/Integrator2' */
  real_T Integrator2_CSTATE_c;         /* '<S9>/Integrator2' */
  real_T Integrator1_CSTATE;           /* '<S11>/Integrator1' */
  real_T Integrator1_CSTATE_m;         /* '<S12>/Integrator1' */
  real_T Integrator2_CSTATE_f;         /* '<S10>/Integrator2' */
  ...
  real_T Integrator1_CSTATE_b;         /* '<S9>/Integrator1' */
  real_T Integrator1_CSTATE_n;         /* '<S10>/Integrator1' */
  real_T Integrator2_CSTATE_m;         /* '<S11>/Integrator2' */
  real_T Integrator2_CSTATE_b;         /* '<S12>/Integrator2' */
  real_T Integrator1_CSTATE_ng;        /* '<S6>/Integrator1' */
...
typedef struct {
  ...
  boolean_T Integrator2_CSTATE_i;      /* '<S8>/Integrator2' */
  boolean_T Integrator2_CSTATE_c;      /* '<S9>/Integrator2' */
  boolean_T Integrator1_CSTATE;        /* '<S11>/Integrator1' */
  boolean_T Integrator1_CSTATE_m;      /* '<S12>/Integrator1' */
  boolean_T Integrator2_CSTATE_f;      /* '<S10>/Integrator2' */
  ...
  boolean_T Integrator1_CSTATE_b;      /* '<S9>/Integrator1' */
  boolean_T Integrator1_CSTATE_n;      /* '<S10>/Integrator1' */
  boolean_T Integrator2_CSTATE_m;      /* '<S11>/Integrator2' */
  boolean_T Integrator2_CSTATE_b;      /* '<S12>/Integrator2' */
  boolean_T Integrator1_CSTATE_ng;     /* '<S6>/Integrator1' */
...
#define rtPrevZCSigState               test2_PrevZCX
#define PrevZCSigStates                PrevZCX_test2_T
...
struct P_test2_T_ {
  ...
  real_T Gain3_Gain;                   /* Expression: 0.033
                                        ...
                                        */
  real_T Gain1_Gain_k;                 /* Expression: 1/(4*720)
                                        * Referenced by: '<S14>/Gain1'
                                        */
  real_T Gain4_Gain_a;                 /* Expression: (13*19)/(70*37)
                                        * Referenced by: '<S14>/Gain4'
                                        */
  real_T Gain2_Gain_o;                 /* Expression: 2*pi
                                        * Referenced by: '<S14>/Gain2'
                                        */
  real_T Gain3_Gain_h;                 /* Expression: 0.033
                                        * Referenced by: '<S14>/Gain3'
                                        */
  real_T Constant11_Value_j;           /* Expression: 0.5
  ...
  real_T commandsaturation1_UpperSat;  /* Expression: 0.5
                                        * Referenced by: '<S6>/command saturation1'
                                        */
  ...
  real_T commandsaturation_LowerSat_i; /* Expression: -0.25
                                        * Referenced by: '<S5>/command saturation'
                                        */
  real_T Constant1_Value_e;            /* Expression: 0.25
...
/* Zero-crossing (trigger) state */
extern PrevZCX_test2_T test2_PrevZCX;
 ...
 * '<S1>'   : 'test2/PosX'
 * '<S2>'   : 'test2/PosY'
 * '<S3>'   : 'test2/Powered by QUARC'
 * '<S4>'   : 'test2/Quanser'
 * '<S5>'   : 'test2/basicQCarIO'
 * '<S6>'   : 'test2/speedController'
 * '<S7>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S8>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S9>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S10>'  : 'test2/basicQCarIO/Second-Order Low-Pass Filter3'
 * '<S11>'  : 'test2/basicQCarIO/Second-Order Low-Pass Filter4'
 * '<S12>'  : 'test2/basicQCarIO/Second-Order Low-Pass Filter5'
 * '<S13>'  : 'test2/basicQCarIO/SpeedEstimation'
 * '<S14>'  : 'test2/basicQCarIO/SpeedEstimation1'
 * '<S15>'  : 'test2/speedController/Compare To Zero'
 */
