...
typedef struct {
  ...
  real_T Product1_p;                   /* '<S8>/Product1' */
  real_T motorcurrent[2];              /* '<S3>/HIL Read' */
  real_T motorencoder;                 /* '<S3>/HIL Read' */
  real_T motorvelocity;                /* '<S3>/HIL Read' */
  real_T Integrator1;                  /* '<S7>/Integrator1' */
  real_T Integrator1_c;                /* '<S6>/Integrator1' */
  real_T Gain3;                        /* '<S3>/Gain3' */
  real_T Unwrap224;                    /* '<S3>/Unwrap 2^24' */
  real_T Product;                      /* '<S5>/Product' */
  real_T Product_b;                    /* '<S6>/Product' */
  real_T Product1_c;                   /* '<S6>/Product1' */
  real_T Product_a;                    /* '<S7>/Product' */
  real_T Product1_n;                   /* '<S7>/Product1' */
  real_T Unwrap21;                     /* '<S3>/Unwrap 2^1' */
  real_T Product_bv;                   /* '<S8>/Product' */
  real_T commandsaturation;            /* '<S3>/command saturation' */
  real_T SteeringBias;                 /* '<S3>/Steering Bias' */
  real_T switch_l;                     /* '<Root>/1 - Arm, 0 - Disarm2' */
  real_T desired;                      /* '<S4>/Multiply1' */
  real_T Kffms;                        /* '<S4>/Kff  (% // m//s)' */
  real_T measured;                     /* '<S4>/Multiply' */
  real_T pwmdutycycle;                 /* '<S4>/Multiply2' */
  real_T Kim;                          /* '<S4>/Ki (% // m)  ' */
...
typedef struct {
  real_T HILInitialize_AIMinimums[5];  /* '<S3>/HIL Initialize' */
  real_T HILInitialize_AIMaximums[5];  /* '<S3>/HIL Initialize' */
  real_T HILInitialize_FilterFrequency[3];/* '<S3>/HIL Initialize' */
  real_T HILInitialize_POSortedFreqs[2];/* '<S3>/HIL Initialize' */
  real_T HILInitialize_POValues[2];    /* '<S3>/HIL Initialize' */
  real_T HILInitialize_OOValues[2];    /* '<S3>/HIL Initialize' */
  real_T Unwrap224_PreviousInput;      /* '<S3>/Unwrap 2^24' */
  real_T Unwrap224_Revolutions;        /* '<S3>/Unwrap 2^24' */
  real_T Unwrap21_PreviousInput;       /* '<S3>/Unwrap 2^1' */
  real_T Unwrap21_Revolutions;         /* '<S3>/Unwrap 2^1' */
  ...
  int32_T HILInitialize_DOStates[16];  /* '<S3>/HIL Initialize' */
  int32_T HILInitialize_QuadratureModes[3];/* '<S3>/HIL Initialize' */
  int32_T HILInitialize_InitialEICounts[3];/* '<S3>/HIL Initialize' */
  int32_T HILInitialize_POModeValues[2];/* '<S3>/HIL Initialize' */
  int32_T HILInitialize_POAlignValues[2];/* '<S3>/HIL Initialize' */
  int32_T HILInitialize_POPolarityVals[2];/* '<S3>/HIL Initialize' */
  int32_T HILRead_EncoderBuffer;       /* '<S3>/HIL Read' */
  uint32_T HILInitialize_POSortedChans[2];/* '<S3>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S7>/Integrator1' */
  int_T Integrator1_IWORK_a;           /* '<S6>/Integrator1' */
  int_T Integrator1_IWORK_g;           /* '<S5>/Integrator1' */
  int_T Integrator1_IWORK_l;           /* '<S8>/Integrator1' */
  boolean_T HILInitialize_DOBits[16];  /* '<S3>/HIL Initialize' */
  boolean_T Unwrap224_FirstSample;     /* '<S3>/Unwrap 2^24' */
  boolean_T Unwrap21_FirstSample;      /* '<S3>/Unwrap 2^1' */
} DW_test2_T;
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_p;         /* '<S5>/Integrator1' */
  real_T Integrator2_CSTATE_m;         /* '<S6>/Integrator2' */
  real_T Integrator2_CSTATE_l;         /* '<S7>/Integrator2' */
  real_T Integrator1_CSTATE_n;         /* '<S8>/Integrator1' */
  real_T Integrator1_CSTATE_ng;        /* '<S4>/Integrator1' */
} X_test2_T;
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_p;      /* '<S5>/Integrator1' */
  boolean_T Integrator2_CSTATE_m;      /* '<S6>/Integrator2' */
  boolean_T Integrator2_CSTATE_l;      /* '<S7>/Integrator2' */
  boolean_T Integrator1_CSTATE_n;      /* '<S8>/Integrator1' */
  boolean_T Integrator1_CSTATE_ng;     /* '<S4>/Integrator1' */
} XDis_test2_T;
...
struct P_test2_T_ {
  ...
  uint32_T HILRead_encoder_channels; /* Mask Parameter: HILRead_encoder_channels
                                      * Referenced by: '<S3>/HIL Read'
                                      */
  uint32_T HILRead_other_channels;     /* Mask Parameter: HILRead_other_channels
                                        * Referenced by: '<S3>/HIL Read'
                                        */
  ...
  real_T Constant_Value_a;             /* Expression: 2
                                        ...
                                        */
  real_T Integrator2_IC_i4;            /* Expression: 0
  ...
  real_T directionconvention_Gain;     /* Expression: +1
                                        ...
                                        */
  real_T commandsaturation_UpperSat;   /* Expression: 0.25
                                        * Referenced by: '<S3>/command saturation'
                                        */
  real_T commandsaturation_LowerSat;   /* Expression: -0.25
                                        * Referenced by: '<S3>/command saturation'
                                        */
  ...
  real_T Constant11_Value;             /* Expression: 0
                                        ...
                                        */
  real_T commandsaturation_UpperSat_l; /* Expression: 0.8
                                        * Referenced by: '<S4>/command saturation'
                                        */
  real_T commandsaturation_LowerSat_i; /* Expression: -0.8
                                        * Referenced by: '<S4>/command saturation'
                                        */
 ...
 *
 * '<Root>' : 'test2'
 * '<S1>'   : 'test2/Powered by QUARC'
 * '<S2>'   : 'test2/Quanser'
 * '<S3>'   : 'test2/basicQCarIO'
 * '<S4>'   : 'test2/speedController'
 * '<S5>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S6>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S7>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S8>'   : 'test2/basicQCarIO/Second-Order Low-Pass Filter3'
 * '<S9>'   : 'test2/speedController/Compare To Zero'
 */
