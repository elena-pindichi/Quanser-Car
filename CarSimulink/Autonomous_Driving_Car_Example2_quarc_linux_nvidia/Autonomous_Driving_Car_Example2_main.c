...
typedef RT_MODEL_Autonomous_Driving_C_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * Autonomous_Driving_Car_Example2(void);
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(Autonomous_Driving_Car_Examp_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: Autonomous_Driving_Car_Example2 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,
   ...
   ************************/
  S = Autonomous_Driving_Car_Example2();
  if (rtmGetErrorStatus(S) != NULL) {
              ...
              if (result == 0) {
                ...
                while (result == 0) {
...

                  {
                    ...
                    if (local_result < 0) {
                      msg_get_error_messageA(NULL, local_result,
                        _rt_error_message, sizeof(_rt_error_message));
                      rtmSetErrorStatus(Autonomous_Driving_Car_Examp_M,
                                        _rt_error_message);
                    }
                  }
