...
typedef struct {
  ...
  real_T Integrator1_g;                /* '<S17>/Integrator1' */
  ...
  real_T Product1_i;                   /* '<S13>/Product1' */
  real_T Product_m;                    /* '<S14>/Product' */
  real_T Product1_n;                   /* '<S14>/Product1' */
  real_T Unwrap21;                     /* '<S8>/Unwrap 2^1' */
  real_T Product_b;                    /* '<S15>/Product' */
  real_T Product_e;                    /* '<S16>/Product' */
  ...
  real_T Product1_b3;                  /* '<S11>/Product1' */
...
typedef struct {
  ...
  int_T Integrator1_IWORK_g;           /* '<S12>/Integrator1' */
...
typedef struct {
  real_T Integrator2_CSTATE;           /* '<S12>/Integrator2' */
  real_T Integrator1_CSTATE;           /* '<S16>/Integrator1' */
  real_T Integrator1_CSTATE_m;         /* '<S17>/Integrator1' */
  real_T Integrator2_CSTATE_f;         /* '<S15>/Integrator2' */
  real_T Integrator_CSTATE;            /* '<S8>/Integrator' */
  real_T Integrator1_CSTATE_p;         /* '<S12>/Integrator1' */
  real_T Integrator1_CSTATE_h;         /* '<S13>/Integrator1' */
  real_T Integrator2_CSTATE_i;         /* '<S13>/Integrator2' */
  real_T Integrator1_CSTATE_b;         /* '<S14>/Integrator1' */
  real_T Integrator2_CSTATE_c;         /* '<S14>/Integrator2' */
  real_T Integrator1_CSTATE_n;         /* '<S15>/Integrator1' */
  real_T Integrator2_CSTATE_m;         /* '<S16>/Integrator2' */
  real_T Integrator2_CSTATE_b;         /* '<S17>/Integrator2' */
  ...
  real_T Integrator1_CSTATE_me;        /* '<S11>/Integrator1' */
  real_T Integrator2_CSTATE_k;         /* '<S11>/Integrator2' */
} X_MPC_casadi_T;
...
/* State disabled  */
typedef struct {
  boolean_T Integrator2_CSTATE;        /* '<S12>/Integrator2' */
  boolean_T Integrator1_CSTATE;        /* '<S16>/Integrator1' */
  boolean_T Integrator1_CSTATE_m;      /* '<S17>/Integrator1' */
  boolean_T Integrator2_CSTATE_f;      /* '<S15>/Integrator2' */
  boolean_T Integrator_CSTATE;         /* '<S8>/Integrator' */
  boolean_T Integrator1_CSTATE_p;      /* '<S12>/Integrator1' */
  boolean_T Integrator1_CSTATE_h;      /* '<S13>/Integrator1' */
  boolean_T Integrator2_CSTATE_i;      /* '<S13>/Integrator2' */
  boolean_T Integrator1_CSTATE_b;      /* '<S14>/Integrator1' */
  boolean_T Integrator2_CSTATE_c;      /* '<S14>/Integrator2' */
  boolean_T Integrator1_CSTATE_n;      /* '<S15>/Integrator1' */
  boolean_T Integrator2_CSTATE_m;      /* '<S16>/Integrator2' */
  boolean_T Integrator2_CSTATE_b;      /* '<S17>/Integrator2' */
  ...
  boolean_T Integrator1_CSTATE_me;     /* '<S11>/Integrator1' */
  boolean_T Integrator2_CSTATE_k;      /* '<S11>/Integrator2' */
} XDis_MPC_casadi_T;
 ...
 * '<S4>'   : 'MPC_casadi/PosX'
 * '<S5>'   : 'MPC_casadi/PosY'
 * '<S6>'   : 'MPC_casadi/Powered by QUARC'
 * '<S7>'   : 'MPC_casadi/Quanser'
 * '<S8>'   : 'MPC_casadi/basicQCarIO'
 * '<S9>'   : 'MPC_casadi/speedController'
 * '<S10>'  : 'MPC_casadi/Current flat output/Dynamics'
 * '<S11>'  : 'MPC_casadi/Filter/Second-Order Low-Pass Filter1'
 * '<S12>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S13>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S14>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S15>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter3'
 * '<S16>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter4'
 * '<S17>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter5'
 * '<S18>'  : 'MPC_casadi/basicQCarIO/SpeedEstimation'
 * '<S19>'  : 'MPC_casadi/basicQCarIO/SpeedEstimation1'
 * '<S20>'  : 'MPC_casadi/speedController/Compare To Zero'
 */
