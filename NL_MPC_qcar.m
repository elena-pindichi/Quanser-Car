...
grid
exportgraphics(gcf, '4NMPC_err.pdf', 'ContentType','vector', 'BackgroundColor','none')
...
exportgraphics(gcf, '4NMPC_state.pdf', 'ContentType','vector', 'BackgroundColor','none')
...
legend('\omega')
grid
exportgraphics(gcf, '4NMPC_input.pdf', 'ContentType','vector', 'BackgroundColor','none')
