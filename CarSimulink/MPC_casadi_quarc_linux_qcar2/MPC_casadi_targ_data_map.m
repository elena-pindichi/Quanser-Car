    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(47)  = dumData; %prealloc
                    ...
                    section.data(46).dtTransOffset = 133;

                    ;% MPC_casadi_B.w_ref
                    section.data(47).logicalSrcIdx = 46;
                    section.data(47).dtTransOffset = 145;
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(23)  = dumData; %prealloc
                    ...
                    section.data(18).logicalSrcIdx = 17;
                    section.data(18).dtTransOffset = 1000157;

                    ;% MPC_casadi_DW.RT_Buffer0
                    section.data(19).logicalSrcIdx = 18;
                    section.data(19).dtTransOffset = 2000157;

                    ;% MPC_casadi_DW.Unwrap21_PreviousInput_d
                    section.data(20).logicalSrcIdx = 19;
                    section.data(20).dtTransOffset = 2000211;

                    ;% MPC_casadi_DW.Unwrap21_Revolutions_o
                    section.data(21).logicalSrcIdx = 20;
                    section.data(21).dtTransOffset = 2000212;

                    ;% MPC_casadi_DW.idx
                    section.data(22).logicalSrcIdx = 21;
                    section.data(22).dtTransOffset = 2000213;

                    ;% MPC_casadi_DW.z_ref_internal
                    section.data(23).logicalSrcIdx = 22;
                    section.data(23).dtTransOffset = 2000214;
