...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/test.rt-linux_qcar2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/test_quarc_linux_qcar2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=test -DNUMST=2 -DNCSTATES=19 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/test_quarc_linux_qcar2/rtGetInf.c $(START_DIR)/test_quarc_linux_qcar2/rtGetNaN.c $(START_DIR)/test_quarc_linux_qcar2/rt_nonfinite.c $(START_DIR)/test_quarc_linux_qcar2/test.c $(START_DIR)/test_quarc_linux_qcar2/test_data.c $(START_DIR)/test_quarc_linux_qcar2/test_main.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c $(START_DIR)/casadi_fun.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = rt_matrx.o rt_printf.o rtGetInf.o rtGetNaN.o rt_nonfinite.o test.o test_data.o test_main.o rt_sim.o casadi_fun.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/test_quarc_linux_qcar2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/test_quarc_linux_qcar2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
rtGetInf.o : $(START_DIR)/test_quarc_linux_qcar2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/test_quarc_linux_qcar2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/test_quarc_linux_qcar2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test.o : $(START_DIR)/test_quarc_linux_qcar2/test.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test_data.o : $(START_DIR)/test_quarc_linux_qcar2/test_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


test_main.o : $(START_DIR)/test_quarc_linux_qcar2/test_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"
