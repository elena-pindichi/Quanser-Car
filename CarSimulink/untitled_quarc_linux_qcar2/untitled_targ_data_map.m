    ...
    ;%***********************
        ...
        ;%
            ...
            section.data(2)  = dumData; %prealloc
                    ...
                    ;% untitled_P.HILWrite_other_channels
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% untitled_P.HILInitialize_DIChannels
    ...
    ;%**************************
        ...
        ;%
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% untitled_B.HILRead_o1
                    section.data(1).logicalSrcIdx = 0;
                    section.data(1).dtTransOffset = 0;

                    ;% untitled_B.HILRead_o2
                    section.data(2).logicalSrcIdx = 1;
                    section.data(2).dtTransOffset = 1;

                    ;% untitled_B.HILRead_o3
                    section.data(3).logicalSrcIdx = 2;
                    section.data(3).dtTransOffset = 2;

                    ;% untitled_B.HILRead_o4
                    section.data(4).logicalSrcIdx = 3;
                    section.data(4).dtTransOffset = 3;

                    ;% untitled_B.HILRead_o5
                    section.data(5).logicalSrcIdx = 4;
                    section.data(5).dtTransOffset = 4;

                    ;% untitled_B.Integrator1
                    section.data(6).logicalSrcIdx = 5;
                    section.data(6).dtTransOffset = 5;

                    ;% untitled_B.Integrator
    ...
    ;%*******************
        ...
        ;%
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.HILInitialize_OOValues
                    section.data(6).logicalSrcIdx = 5;
            ...
            section.data(7)  = dumData; %prealloc
                    ...
                    ;% untitled_DW.AccX_PWORK.LoggedData
                    section.data(2).logicalSrcIdx = 9;
                    section.data(2).dtTransOffset = 1;

                    ;% untitled_DW.AccY_PWORK.LoggedData
                    section.data(3).logicalSrcIdx = 10;
                    section.data(3).dtTransOffset = 2;

                    ;% untitled_DW.AccZ_PWORK.LoggedData
                    section.data(4).logicalSrcIdx = 11;
                    section.data(4).dtTransOffset = 3;

                    ;% untitled_DW.E1V_PWORK.LoggedData
                    section.data(5).logicalSrcIdx = 12;
                    section.data(5).dtTransOffset = 4;

                    ;% untitled_DW.E2V_PWORK.LoggedData
                    section.data(6).logicalSrcIdx = 13;
                    section.data(6).dtTransOffset = 5;

                    ;% untitled_DW.HILWrite_PWORK
    ...
    targMap.checksum0 = 2488324635;
    targMap.checksum1 = 932738418;
    targMap.checksum2 = 3194061504;
    targMap.checksum3 = 2990851891;
