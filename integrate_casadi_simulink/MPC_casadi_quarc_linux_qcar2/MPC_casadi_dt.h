...
static DataTypeTransition rtBTransitions[] = {
  { (char_T *)(&MPC_casadi_B.Product1), 0, 0, 111 },

  { (char_T *)(&MPC_casadi_B.Compare), 8, 0, 1 }
  ,

  { (char_T *)(&MPC_casadi_DW.Buffer_CircBuf[0]), 0, 0, 2000194 },

  { (char_T *)(&MPC_casadi_DW.HILInitialize_Card), 17, 0, 1 },

  { (char_T *)(&MPC_casadi_DW.HILRead_PWORK), 11, 0, 10 },
  ...
  { (char_T *)(&MPC_casadi_DW.is_active_c2_MPC_casadi), 3, 0, 3 },
