###########################################################################
## Makefile generated for component 'MPC_fmincon'. 
## 
## Makefile     : MPC_fmincon.mk
## Generated on : Mon May 26 13:27:28 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MPC_fmincon.rt-linux_qcar2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MPC_fmincon.rt-linux_qcar2
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/MPC_fmincon_quarc_linux_qcar2 -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src/utils -IC:/PROGRA~1/Quanser/QUARC/include
...
DEFINES_STANDARD = -DMODEL=MPC_fmincon -DNUMST=2 -DNCSTATES=19 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon.c $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon_data.c $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon_main.c $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rtGetInf.c $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rtGetNaN.c $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = MPC_fmincon.o MPC_fmincon_data.o MPC_fmincon_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
MPC_fmincon.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon.c
	$(CC) $(CFLAGS) -o"$@" "$<"


MPC_fmincon_data.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


MPC_fmincon_main.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/MPC_fmincon_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/MPC_fmincon_quarc_linux_qcar2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
