###########################################################################
## Makefile generated for component 'MPC_casadi'. 
## 
## Makefile     : MPC_casadi.mk
## Generated on : Mon May 26 16:26:47 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/MPC_casadi.rt-linux_qcar2
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/MPC_casadi.rt-linux_qcar2
...
DEFINES_STANDARD = -DMODEL=MPC_casadi -DNUMST=4 -DNCSTATES=19 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)/rtw/c/src/rt_matrx.c $(MATLAB_ROOT)/rtw/c/src/rt_printf.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi_data.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi_main.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rtGetInf.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rtGetNaN.c $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rt_nonfinite.c $(MATLAB_ROOT)/rtw/c/src/rt_sim.c $(START_DIR)/casadi_fun.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_svr.c C:/PROGRA~1/Quanser/QUARC/quarc/src/updown.c C:/PROGRA~1/Quanser/QUARC/quarc/src/ext_work.c
...
OBJS = rt_matrx.o rt_printf.o MPC_casadi.o MPC_casadi_data.o MPC_casadi_main.o rtGetInf.o rtGetNaN.o rt_nonfinite.o rt_sim.o casadi_fun.o ext_svr.o updown.o ext_work.o
...
%.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/%.c
	$(CC) $(CFLAGS) -o"$@" "$<"


%.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/%.cpp
	$(CPP) $(CPPFLAGS) -o"$@" "$<"
...
MPC_casadi.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi.c
	$(CC) $(CFLAGS) -o"$@" "$<"


MPC_casadi_data.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi_data.c
	$(CC) $(CFLAGS) -o"$@" "$<"


MPC_casadi_main.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/MPC_casadi_main.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetInf.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rtGetInf.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rtGetNaN.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rtGetNaN.c
	$(CC) $(CFLAGS) -o"$@" "$<"


rt_nonfinite.o : $(START_DIR)/MPC_casadi_quarc_linux_qcar2/rt_nonfinite.c
	$(CC) $(CFLAGS) -o"$@" "$<"
...
casadi_fun.o : $(START_DIR)/casadi_fun.c
	$(CC) $(CFLAGS) -o"$@" "$<"
