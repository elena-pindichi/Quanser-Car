...
#ifndef RTW_HEADER_MPC_fmincon_h_
#define RTW_HEADER_MPC_fmincon_h_
#ifndef MPC_fmincon_COMMON_INCLUDES_
#define MPC_fmincon_COMMON_INCLUDES_
#include <stdio.h>
#include <string.h>
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* MPC_fmincon_COMMON_INCLUDES_ */
...
#define MPC_fmincon_rtModel            RT_MODEL_MPC_fmincon_T
...
typedef struct {
  ...
  uint8_T is_active_c4_MPC_fmincon;    /* '<Root>/MATLAB Function2' */
  uint8_T is_active_c2_MPC_fmincon;    /* '<Root>/MATLAB Function' */
...
#define rtB                            MPC_fmincon_B
#define BlockIO                        B_MPC_fmincon_T
#define rtX                            MPC_fmincon_X
#define ContinuousStates               X_MPC_fmincon_T
#define rtXdot                         MPC_fmincon_XDot
#define StateDerivatives               XDot_MPC_fmincon_T
#define tXdis                          MPC_fmincon_XDis
#define StateDisabled                  XDis_MPC_fmincon_T
#define rtP                            MPC_fmincon_P
#define Parameters                     P_MPC_fmincon_T
#define rtDWork                        MPC_fmincon_DW
#define D_Work                         DW_MPC_fmincon_T
#define rtPrevZCSigState               MPC_fmincon_PrevZCX
#define PrevZCSigStates                PrevZCX_MPC_fmincon_T

/* Parameters (default storage) */
struct P_MPC_fmincon_T_ {
...
extern P_MPC_fmincon_T MPC_fmincon_P;

/* Block signals (default storage) */
extern B_MPC_fmincon_T MPC_fmincon_B;

/* Continuous states (default storage) */
extern X_MPC_fmincon_T MPC_fmincon_X;

/* Block states (default storage) */
extern DW_MPC_fmincon_T MPC_fmincon_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_MPC_fmincon_T MPC_fmincon_PrevZCX;

/* Model entry point functions */
extern void MPC_fmincon_initialize(void);
extern void MPC_fmincon_output(void);
extern void MPC_fmincon_update(void);
extern void MPC_fmincon_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern MPC_fmincon_rtModel *MPC_fmincon(void);
...
extern RT_MODEL_MPC_fmincon_T *const MPC_fmincon_M;
 ...
 *
 * '<Root>' : 'MPC_fmincon'
 * '<S1>'   : 'MPC_fmincon/Filter'
 * '<S2>'   : 'MPC_fmincon/MATLAB Function'
 * '<S3>'   : 'MPC_fmincon/MATLAB Function2'
 * '<S4>'   : 'MPC_fmincon/PosX'
 * '<S5>'   : 'MPC_fmincon/PosY'
 * '<S6>'   : 'MPC_fmincon/Powered by QUARC'
 * '<S7>'   : 'MPC_fmincon/Quanser'
 * '<S8>'   : 'MPC_fmincon/basicQCarIO'
 * '<S9>'   : 'MPC_fmincon/speedController'
 * '<S10>'  : 'MPC_fmincon/Filter/Second-Order Low-Pass Filter1'
 * '<S11>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S12>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S13>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S14>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter3'
 * '<S15>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter4'
 * '<S16>'  : 'MPC_fmincon/basicQCarIO/Second-Order Low-Pass Filter5'
 * '<S17>'  : 'MPC_fmincon/basicQCarIO/SpeedEstimation'
 * '<S18>'  : 'MPC_fmincon/basicQCarIO/SpeedEstimation1'
 * '<S19>'  : 'MPC_fmincon/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_MPC_fmincon_h_ */
