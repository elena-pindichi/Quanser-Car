...
#ifndef RTW_HEADER_MPC_casadi_h_
#define RTW_HEADER_MPC_casadi_h_
#ifndef MPC_casadi_COMMON_INCLUDES_
#define MPC_casadi_COMMON_INCLUDES_
#include "rtwtypes.h"
#include "simstruc.h"
...
#endif                                 /* MPC_casadi_COMMON_INCLUDES_ */
...
#define MPC_casadi_rtModel             RT_MODEL_MPC_casadi_T

/* Block signals (default storage) */
typedef struct {
  real_T wref_data[1202];
  real_T Vr_data[601];
  real_T thetar_data[601];
  real_T phir_data[601];
  real_T phir_tmp_data[601];
  real_T Product1;                     /* '<S13>/Product1' */
  real_T analogpower;                  /* '<S9>/HIL Read' */
  real_T motorencoder;                 /* '<S9>/HIL Read' */
  real_T HILRead_o3[4];                /* '<S9>/HIL Read' */
  real_T Integrator1;                  /* '<S17>/Integrator1' */
  real_T Unwrap22;                     /* '<S9>/Unwrap 2^2' */
  real_T Integrator1_g;                /* '<S18>/Integrator1' */
  real_T Product1_p;                   /* '<S16>/Product1' */
  real_T Integrator;                   /* '<S9>/Integrator' */
  real_T Unwrap224;                    /* '<S9>/Unwrap 2^24' */
  real_T Product;                      /* '<S13>/Product' */
  real_T Product_d;                    /* '<S14>/Product' */
  real_T Product1_i;                   /* '<S14>/Product1' */
  real_T Product_m;                    /* '<S15>/Product' */
  real_T Product1_n;                   /* '<S15>/Product1' */
  real_T Unwrap21;                     /* '<S9>/Unwrap 2^1' */
  real_T Product_b;                    /* '<S16>/Product' */
  real_T Product_e;                    /* '<S17>/Product' */
  real_T Product1_b;                   /* '<S17>/Product1' */
  real_T Product_p;                    /* '<S18>/Product' */
  real_T Product1_g;                   /* '<S18>/Product1' */
  real_T Gain3;                        /* '<S19>/Gain3' */
  real_T Integrator5;                  /* '<S5>/Integrator5' */
  real_T Integrator6;                  /* '<S6>/Integrator6' */
  ...
  real_T commandsaturation;            /* '<S9>/command saturation' */
  real_T SteeringBias;                 /* '<S9>/Steering Bias' */
  real_T RT_m[54];                     /* '<S1>/RT' */
  real_T Unwrap21_o;                   /* '<S3>/Unwrap 2^1' */
  real_T Integrator1_f;                /* '<S12>/Integrator1' */
  real_T Product_g;                    /* '<S12>/Product' */
  real_T Product1_b3;                  /* '<S12>/Product1' */
  real_T Product_f;                    /* '<S5>/Product' */
  real_T Product1_ij;                  /* '<S6>/Product1' */
  real_T Kim;                          /* '<S10>/Ki (% // m)  ' */
  real_T FromWorkspace1[9];            /* '<Root>/From Workspace1' */
  real_T w[2];                         /* '<Root>/MATLAB Function' */
  real_T u[2];                         /* '<Root>/FL U Mapping' */
  real_T z_next[2];                    /* '<S1>/Dynamics' */
  real_T z_ref[12];                    /* '<S1>/Dynamics' */
  real_T w_ref[10];                    /* '<S1>/Dynamics' */
...
typedef struct {
  ...
  real_T Unwrap22_PreviousInput;       /* '<S9>/Unwrap 2^2' */
  real_T Unwrap22_Revolutions;         /* '<S9>/Unwrap 2^2' */
  real_T Unwrap224_PreviousInput;      /* '<S9>/Unwrap 2^24' */
  real_T Unwrap224_Revolutions;        /* '<S9>/Unwrap 2^24' */
  real_T Unwrap21_PreviousInput;       /* '<S9>/Unwrap 2^1' */
  real_T Unwrap21_Revolutions;         /* '<S9>/Unwrap 2^1' */
  real_T RT_Buffer0[54];               /* '<S1>/RT' */
  real_T XYFigure_XBuffer[1000000];    /* '<Root>/XY Figure' */
  real_T XYFigure_YBuffer[1000000];    /* '<Root>/XY Figure' */
  real_T Unwrap21_PreviousInput_d;     /* '<S3>/Unwrap 2^1' */
  real_T Unwrap21_Revolutions_o;       /* '<S3>/Unwrap 2^1' */
  real_T idx;                          /* '<S1>/Dynamics' */
  real_T z_ref_internal[2];            /* '<S1>/Dynamics' */
  t_card HILInitialize_Card;           /* '<S9>/HIL Initialize' */
  void *HILRead_PWORK;                 /* '<S9>/HIL Read' */
  void *HILWrite_PWORK;                /* '<S9>/HIL Write' */
  struct {
    void *LoggedData[3];
  ...
  int32_T HILRead_EncoderBuffer;       /* '<S9>/HIL Read' */
  int32_T sfEvent;                     /* '<Root>/MATLAB Function' */
  int32_T sfEvent_l;                   /* '<Root>/FL U Mapping' */
  int32_T sfEvent_lt;                  /* '<S1>/Dynamics' */
  uint32_T HILInitialize_POSortedChans[2];/* '<S9>/HIL Initialize' */
  int_T Integrator1_IWORK;             /* '<S17>/Integrator1' */
  int_T Integrator1_IWORK_i;           /* '<S18>/Integrator1' */
  int_T Integrator1_IWORK_g;           /* '<S13>/Integrator1' */
  int_T Integrator1_IWORK_d;           /* '<S14>/Integrator1' */
  int_T Integrator1_IWORK_gg;          /* '<S15>/Integrator1' */
  int_T Integrator1_IWORK_l;           /* '<S16>/Integrator1' */
  int_T XYFigure_IWORK[2];             /* '<Root>/XY Figure' */
  int_T Integrator1_IWORK_a;           /* '<S12>/Integrator1' */
  struct {
    int_T PrevIndex;
  } FromWorkspace1_IWORK;              /* '<Root>/From Workspace1' */

  uint8_T is_active_c4_MPC_casadi;     /* '<Root>/MATLAB Function' */
  ...
  boolean_T Unwrap22_FirstSample;      /* '<S9>/Unwrap 2^2' */
  boolean_T Unwrap224_FirstSample;     /* '<S9>/Unwrap 2^24' */
  boolean_T Unwrap21_FirstSample;      /* '<S9>/Unwrap 2^1' */
  ...
  boolean_T doneDoubleBufferReInit_b;  /* '<Root>/FL U Mapping' */
...
typedef struct {
  ...
  real_T Integrator1_CSTATE_m;         /* '<S18>/Integrator1' */
  real_T Integrator2_CSTATE_f;         /* '<S16>/Integrator2' */
  real_T Integrator_CSTATE;            /* '<S9>/Integrator' */
  real_T Integrator1_CSTATE_p;         /* '<S13>/Integrator1' */
  real_T Integrator1_CSTATE_h;         /* '<S14>/Integrator1' */
  real_T Integrator2_CSTATE_i;         /* '<S14>/Integrator2' */
  real_T Integrator1_CSTATE_b;         /* '<S15>/Integrator1' */
  real_T Integrator2_CSTATE_c;         /* '<S15>/Integrator2' */
  real_T Integrator1_CSTATE_n;         /* '<S16>/Integrator1' */
  real_T Integrator2_CSTATE_m;         /* '<S17>/Integrator2' */
  real_T Integrator2_CSTATE_b;         /* '<S18>/Integrator2' */
  real_T Integrator5_CSTATE;           /* '<S5>/Integrator5' */
  real_T Integrator6_CSTATE;           /* '<S6>/Integrator6' */
  real_T Integrator3_CSTATE;           /* '<S3>/Integrator3' */
  real_T Integrator1_CSTATE_ng;        /* '<S10>/Integrator1' */
  real_T Integrator1_CSTATE_me;        /* '<S12>/Integrator1' */
  real_T Integrator2_CSTATE_k;         /* '<S12>/Integrator2' */
} X_MPC_casadi_T;
...
typedef struct {
  ...
  boolean_T Integrator1_CSTATE_m;      /* '<S18>/Integrator1' */
  boolean_T Integrator2_CSTATE_f;      /* '<S16>/Integrator2' */
  boolean_T Integrator_CSTATE;         /* '<S9>/Integrator' */
  boolean_T Integrator1_CSTATE_p;      /* '<S13>/Integrator1' */
  boolean_T Integrator1_CSTATE_h;      /* '<S14>/Integrator1' */
  boolean_T Integrator2_CSTATE_i;      /* '<S14>/Integrator2' */
  boolean_T Integrator1_CSTATE_b;      /* '<S15>/Integrator1' */
  boolean_T Integrator2_CSTATE_c;      /* '<S15>/Integrator2' */
  boolean_T Integrator1_CSTATE_n;      /* '<S16>/Integrator1' */
  boolean_T Integrator2_CSTATE_m;      /* '<S17>/Integrator2' */
  boolean_T Integrator2_CSTATE_b;      /* '<S18>/Integrator2' */
  boolean_T Integrator5_CSTATE;        /* '<S5>/Integrator5' */
  boolean_T Integrator6_CSTATE;        /* '<S6>/Integrator6' */
  boolean_T Integrator3_CSTATE;        /* '<S3>/Integrator3' */
  boolean_T Integrator1_CSTATE_ng;     /* '<S10>/Integrator1' */
  boolean_T Integrator1_CSTATE_me;     /* '<S12>/Integrator1' */
  boolean_T Integrator2_CSTATE_k;      /* '<S12>/Integrator2' */
} XDis_MPC_casadi_T;

/* Zero-crossing (trigger) state */
typedef struct {
  ZCSigState Integrator1_Reset_ZCE;    /* '<S10>/Integrator1' */
} PrevZCX_MPC_casadi_T;
...
#define rtB                            MPC_casadi_B
#define BlockIO                        B_MPC_casadi_T
#define rtX                            MPC_casadi_X
#define ContinuousStates               X_MPC_casadi_T
#define rtXdot                         MPC_casadi_XDot
#define StateDerivatives               XDot_MPC_casadi_T
#define tXdis                          MPC_casadi_XDis
#define StateDisabled                  XDis_MPC_casadi_T
#define rtP                            MPC_casadi_P
#define Parameters                     P_MPC_casadi_T
#define rtDWork                        MPC_casadi_DW
#define D_Work                         DW_MPC_casadi_T
#define rtPrevZCSigState               MPC_casadi_PrevZCX
#define PrevZCSigStates                PrevZCX_MPC_casadi_T

/* Parameters (default storage) */
struct P_MPC_casadi_T_ {
...
extern P_MPC_casadi_T MPC_casadi_P;

/* Block signals (default storage) */
extern B_MPC_casadi_T MPC_casadi_B;

/* Continuous states (default storage) */
extern X_MPC_casadi_T MPC_casadi_X;

/* Block states (default storage) */
extern DW_MPC_casadi_T MPC_casadi_DW;

/* Zero-crossing (trigger) state */
extern PrevZCX_MPC_casadi_T MPC_casadi_PrevZCX;
...
extern void MPC_casadi_initialize(void);
extern void MPC_casadi_output0(void);
extern void MPC_casadi_update0(void);
extern void MPC_casadi_output2(void);
extern void MPC_casadi_update2(void);
extern void MPC_casadi_output3(void);
extern void MPC_casadi_update3(void);
extern void MPC_casadi_terminate(void);

/*====================*
 * External functions *
 *====================*/
extern MPC_casadi_rtModel *MPC_casadi(void);
...
extern RT_MODEL_MPC_casadi_T *const MPC_casadi_M;
 ...
 *
 * '<Root>' : 'MPC_casadi'
 * '<S1>'   : 'MPC_casadi/Current flat output'
 * '<S2>'   : 'MPC_casadi/FL U Mapping'
 * '<S3>'   : 'MPC_casadi/Filter'
 * '<S4>'   : 'MPC_casadi/MATLAB Function'
 * '<S5>'   : 'MPC_casadi/PosX'
 * '<S6>'   : 'MPC_casadi/PosY'
 * '<S7>'   : 'MPC_casadi/Powered by QUARC'
 * '<S8>'   : 'MPC_casadi/Quanser'
 * '<S9>'   : 'MPC_casadi/basicQCarIO'
 * '<S10>'  : 'MPC_casadi/speedController'
 * '<S11>'  : 'MPC_casadi/Current flat output/Dynamics'
 * '<S12>'  : 'MPC_casadi/Filter/Second-Order Low-Pass Filter1'
 * '<S13>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter'
 * '<S14>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter1'
 * '<S15>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter2'
 * '<S16>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter3'
 * '<S17>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter4'
 * '<S18>'  : 'MPC_casadi/basicQCarIO/Second-Order Low-Pass Filter5'
 * '<S19>'  : 'MPC_casadi/basicQCarIO/SpeedEstimation'
 * '<S20>'  : 'MPC_casadi/basicQCarIO/SpeedEstimation1'
 * '<S21>'  : 'MPC_casadi/speedController/Compare To Zero'
 */
#endif                                 /* RTW_HEADER_MPC_casadi_h_ */
